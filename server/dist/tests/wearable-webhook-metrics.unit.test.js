...
(0, node_test_1.default)("wearable webhook metrics aggregates status and provider counts", async () => {
    ...
    const snapshot = await (0, wearable_webhook_metrics_1.getWearableWebhookAuditSnapshot)(60);
    ...
    strict_1.default.ok(snapshot.source === "database" || snapshot.source === "memory_fallback");
});
